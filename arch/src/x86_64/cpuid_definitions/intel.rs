...
use super::{
    CpuidDefinitions, CpuidReg, MigrationCompatibilityRequirement, Parameters, ProfilePolicy,
    ...
    CpuidDefinitions([
        ...
        (
            ...
            ValueDefinitions::new(&[
                ValueDefinition {
                    ...
                    bits_range: (0, 3),
                    policy: ProfilePolicy::Inherit,
                    migration_compatibility_req: MigrationCompatibilityRequirement::Ignore,
                },
                ValueDefinition {
                    short: "base_model",
        ...
        (
            ...
            ValueDefinitions::new(&[ValueDefinition {
                ...
                bits_range: (0, 15),
                policy: ProfilePolicy::Overwrite(0),
                migration_compatibility_req: MigrationCompatibilityRequirement::LtEq,
            }]),
        ),
        (
            Parameters {
        ...
        */
        ...
        (
            ...
            ValueDefinitions::new(&[ValueDefinition {
                ...
                bits_range: (0, 4),
                policy: ProfilePolicy::Passthrough, /* TODO: ? */
                migration_compatibility_req: MigrationCompatibilityRequirement::Ignore, /* TODO: ? */
            }]),
        ),
        (
            Parameters {
        ...
        (
            ...
            ValueDefinitions::new(&[
                ValueDefinition {
                    ...
                    bits_range: (0, 15),
                    policy: ProfilePolicy::Inherit,
                    migration_compatibility_req: MigrationCompatibilityRequirement::Eq, /* require equality as this can impact XSAVE */
                },
                ValueDefinition {
                    short: "amx_tile_size",
        ...
        (
            ...
            ValueDefinitions::new(&[
                ...
                ValueDefinition {
                    ...
                    bits_range: (16, 31),
                    policy: ProfilePolicy::Inherit,
                    migration_compatibility_req: MigrationCompatibilityRequirement::Eq, /* Can affect XSAVE hence require equality here */
                },
            ]),
        ),
        (
        ...
        (
            ...
            ValueDefinitions::new(&[
                ValueDefinition {
                    ...
                    bits_range: (0, 7),
                    policy: ProfilePolicy::Inherit,
                    migration_compatibility_req: MigrationCompatibilityRequirement::GtEq, /* TODO: OR should we go with Eq? */
                },
                ValueDefinition {
                    short: "tmul_maxn",
