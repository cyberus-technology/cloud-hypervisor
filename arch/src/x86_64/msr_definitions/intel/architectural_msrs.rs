...
mod permitted_architectural_msrs {
    ...
    mod read_write {
        ...
        pub(super) const READ_WRITE_IA32_MSRS: [u32; 82] = [
            IA32_P5_MC_ADDR,
            IA32_P5_MC_TYPE,
            ...
            IA32_SYSENTER_ESP,
            IA32_SYSENTER_EIP,
            // IA32_UMWAIT_CONTROL, Should perhaps not be permitted
    ...
    pub(in crate::x86_64) const PERMITTED_IA32_MSRS: [u32; 126] = const {
        let mut permitted = [0u32; 126];
