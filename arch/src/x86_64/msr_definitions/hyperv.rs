...
//! the Microsoft Hypervisor Top Level Functional Specification document from Feburary 2017.
...
const HV_X64_MSR_SYNTH_DEBUG_CONTRO: u32 = 0x400000F1;
const HV_X64_MSR_SYNTH_DEBUG_STATU: u32 = 0x400000F2;
...
/// Hypervisor Top Level Functional Specification document from Feburary 2017
pub(in crate::x86_64) const HYPERV_MSRS: [u32; 64] = [
    ...
    HV_X64_MSR_SYNTH_DEBUG_CONTRO,
    HV_X64_MSR_SYNTH_DEBUG_STATU,
