...
pub(in crate::x86_64) use forbidden_msrs::PROFILE_UNPERMITTED_MSRS;
...
#[cfg(feature = "cpu_profile_generation")]
mod forbidden_msrs {
    // TODO: Check that the deprecated KVM_CLOCKSOURCE MSRS
    // are disabled via CPUID for non-host CPU profiles
    ...
    pub(in crate::x86_64) const PROFILE_UNPERMITTED_MSRS: [u32; 2] =
...
mod permitted_msrs {
    ...
    pub(in crate::x86_64) const PROFILE_PERMITTED_KVM_MSRS: [u32; 9] = [
