...
mod unit_tests {
    ...
    fn cpu_profile_host_loads_no_data() {
        assert_eq!(CpuProfile::Host.cpuid_data(), None);
    ...
    fn cpu_profile_loading_sapphire_rapids() {
        ...
        let cpuid_data = profile.cpuid_data().unwrap();
        let deserialized_cpuid_data: CpuidProfileData = serde_json::from_slice(include_bytes!(
            "./../cpu_profiles/sapphire-rapids.cpuid.json"
        ))
        .unwrap();
